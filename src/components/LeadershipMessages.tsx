...
বাংলার ছোয়া মডেল সিটি লিমিটেড প্রতিষ্ঠার মূল উদ্দেশ্যই ছিল একটি বিশ্বাসযোগ্য, স্বচ্ছ ও গ্রাহকবান্ধব রিয়েল এস্টেট প্রতিষ্ঠান গড়ে তোলা। আমরা শুধু জমি বা প্লট বিক্রি করি না — আমরা গড়ে তুলি মানুষের স্বপ্নের আশ্রয়।

আমাদের প্রতিটি প্রকল্প পরিকল্পিত, আইনি দিক থেকে নিরাপদ ও আধুনিক নাগরিক সুবিধা সম্পন্ন। গ্রাহকদের সন্তুষ্টিই আমাদের সবচেয়ে বড় অর্জন, তাই আমরা সর্বদা মান, সময়নিষ্ঠা ও প্রতিশ্রুতির প্রতি অটল থাকি।

আমরা বিশ্বাস করি, “একটি জমি শুধু সম্পদ নয়, এটি প্রজন্মের নিরাপত্তা ও ভবিষ্যতের ভরসা।”
এই বিশ্বাস থেকেই আমরা প্রতিটি প্রকল্পে আন্তরিকভাবে কাজ করি, যাতে আপনার বিনিয়োগ নিরাপদ ও লাভজনক হয়।

ভবিষ্যতেও বাংলার ছোয়া মডেল সিটি লিমিটেড গ্রাহকদের আস্থা ও ভালোবাসাকে পুঁজি করে দেশের উন্নয়ন ও আধুনিক আবাসন খাতে নতুন দিগন্ত উন্মোচনে কাজ করে যাবে — এটাই আমাদের অঙ্গীকার।

সবার প্রতি আন্তরিক শুভেচ্ছা ও ধন্যবাদ।`,
    gradient: "from-green-700 to-lime-600",
    bgPattern: "from-green-50 to-lime-50",
    // image: "/avatars/chairman.png",
  },
  {
    title: "ব্যবস্থাপনা পরিচালক (MD)",
    name: "মোঃ এম এম মাসুদ",
    message: `আসসালামু আলাইকুম,

বাংলার ছোয়া  মডেল সিটি লিমিটেড একটি ভিশনভিত্তিক প্রতিষ্ঠান, যার লক্ষ্য শুধু রিয়েল এস্টেট ব্যবসা নয়, বরং মানুষের বাড়ি ও সম্পত্তি কেনার স্বপ্নকে সহজ, নিরাপদ ও হালাল উপায়ে বাস্তবে রূপ দেওয়া।
...
আপনাদের বিশ্বাস ও ভরসা আমাদের অন্যতম প্রেরণা। আমরা চাই, আপনিও এই স্বপ্নযাত্রার গর্বিত অংশ হোন—একটি সুন্দর, পরিকল্পিত, আধুনিক ও সমৃদ্ধশালী ভবিষ্যতের পথে। আপনার স্বপ্ন পূরণে আমরা বদ্ধ পরিকর।`,
  ...
  },
  {
    title: "পরিচালক",
    name: "আসিফ চৌধুরী",
    message: `বাংলার ছোয়া  মডেল সিটি লিমিটেড এমন একটি স্বপ্ন বয়ে চলা প্রতিষ্ঠান, যা মানুষের আবাসনের চাহিদাকে সম্মান করে, এবং সেটিকে বাস্তবতায় রূপ দিতে দৃঢ় প্রতিশ্রুতিবদ্ধ। আমাদের মূল লক্ষ্য-"জমি ও ফ্ল্যাট হোক সবার নাগালে, হালাল ইনকামে নিরাপদ ভবিষ্যতের নিশ্চয়তা।"
...
আপনারা আমাদের পাশে থাকুন—ইনশাআল্লাহ আমরা একসাথে গড়বো আগামীর আস্থার বাংলাদেশ।`,
  ...
  {
    title: "পরিচালক (অপারেশনস)",
    name: "হাসিবুল ইসলাম",
    message: `"বাংলার ছোয়া মডেল সিটি লিমিটেড" এর অংশ হিসেবে আমরা আমাদের লক্ষ্য অর্জনে একসাথে কাজ করছি। আমাদের প্রতিষ্ঠান শহরের আধুনিক এবং উন্নত পরিকাঠামো নির্মাণে প্রতিশ্রুতিবদ্ধ, যা শুধুমাত্র স্থাপত্য এবং অবকাঠামোর উন্নয়ন নয়, বরং সামাজিক, পরিবেশগত এবং অর্থনৈতিক দিক থেকেও সকলের জন্য উন্নতি আনবে।

আমাদের অপারেশনস বিভাগ, সঠিক পরিকল্পনা এবং দক্ষতা ব্যবহারের মাধ্যমে প্রতিটি প্রকল্পের ক্ষেত্রে নতুন মান তৈরি করছে। আমরা প্রযুক্তির সর্বোত্তম ব্যবহার, টেকসই নির্মাণ এবং আমাদের কর্মীদের দক্ষতার উন্নতি নিশ্চিত করে, আমাদের ক্লায়েন্টদের জন্য শ্রেষ্ঠতর সেবা প্রদান করতে প্রতিশ্রুতিবদ্ধ।

এছাড়া, আমাদের লক্ষ্য শুধুমাত্র একটি আবাসন নির্মাণ নয়, বরং এমন একটি শহর তৈরি করা যেখানে প্রত্যেক নাগরিকের জীবনযাত্রার মান উন্নত হবে। আমাদের কাজের মাধ্যমে আমরা বাংলাদেশের অর্থনৈতিক উন্নয়নে একটি গুরুত্বপূর্ণ ভূমিকা রাখতে চাই। আমরা বিশ্বাস করি, সম্মিলিত প্রচেষ্টায় আমরা আমাদের লক্ষ্য বাস্তবায়ন করতে সক্ষম হবো এবং ভবিষ্যতে আরও বড় সফলতা অর্জন করবো।
`,
    gradient: "from-blue-600 to-indigo-600",
    bgPattern: "from-blue-50 to-indigo-50",
  },
