...
export default function ProjectPageComp() {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="show"
      className="py-24 bg-gradient-to-b from-green-50 via-white to-green-50"
    >
      {/* <div className="container mx-auto px-4 max-w-7xl md:py-20"> */}
      ...
      {/* <div className="mb-16 text-center">
          ...
          >
            Discover our curated collection of premium residential projects in Dhaka's most prestigious locations
          </motion.p>
        </div> */}
          ...
          <Card className="p-12 rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 shadow-2xl overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4">
                {[
                  '3 Decimal', '4 Decimal', '5 Decimal', '6 Decimal', '7 Decimal', '8 Decimal',
                  '9 Decimal', '10 Decimal', '3 Katha', '5 Katha', '10 Katha', '1 Bigha'
                ].map((size) => (
                  <motion.div
                    key={size}
